...
artist[8].name = "Vincent Van Gogh"
console.log(artist[8]);
...
console.log(getArtistByIndex(artist,0));
...
addArtist(artist, "Usna", "1996", "Web Development", "American", "Web is so exciting!");
...
artistByCountry(artist, 'Spanish');
